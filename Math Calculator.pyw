...
def Rectangle_Window(): # Rectangle GUI
    ...
    def rec_calculate():
        ...
        # Finds values for calculation and calculates the answer.
        # 
        ...
        # Changing the answer label by addind a NEW label in place of the old one
    ...
    # Lables for Rectangle GUI
    Label (rectangle_w, text="Rectangle Calculator", fg="Black", font="none 16 bold") .grid(row=1, column=0, sticky=W) #Main Heading
    Label (rectangle_w, text="Enter the required measurements & then click calculate to find the area of a rectangle.", fg="Black", font="none 12") .grid(row=2, column=0, sticky=W)#Sub Heading
    ...
    Label (rectangle_w, text=f"Math Calculator v{version_number}", fg="Grey", anchor='se', font="none 8", wraplength=400) .grid(row=8, column=1, sticky=W)#version
...
def Square_Window(): # Square GUI
    ...
    def squ_calculate():
        ...
        # Finds values for numeric check.
    ...
    # Lables for Rectangle GUI
    Label (square_w, text="Square Calculator", fg="Black", font="none 16 bold") .grid(row=1, column=0, sticky=W) #Main Heading
    Label (square_w, text="Enter the required measurements & then click calculate to find the area of a square.", fg="Black", font="none 12") .grid(row=2, column=0, sticky=W)#Sub Heading
    ...
    # Version number and program name
    Label (square_w, text=f"Math Calculator v{version_number}", fg="Grey", anchor='se', font="none 8", wraplength=400) .grid(row=6, column=1, sticky=W)#version
...
def Circle_Window(): # Circle GUI
    ...
    def cir_calculate():
        ...
        c_a = float(c_radius.get()) # I would use the imported decimal function, but it won't work probably because of the pi variable.
        pi = numpy.pi
    ...
    # Lables for Circle GUI
    Label (circle_w, text="Circle Calculator", fg="Black", font="none 16 bold") .grid(row=1, column=0, sticky=W) #Main Heading
    Label (circle_w, text="Enter the required measurements & then click calculate to find the area of a Circle.", fg="Black", font="none 12") .grid(row=2, column=0, sticky=W)#Sub Heading
    ...
    # Version number and program name
    Label (circle_w, text=f"Math Calculator v{version_number}", fg="Grey", anchor='se', font="none 8", wraplength=400) .grid(row=6, column=1, sticky=W)#version
...
def Help_Window(): # Help GUI
    ...
    help_w = Tk() # I think this assigns this variable as the window that can be refered to later.
    ...
    Label (help_w, text="To use this program, enter the required information into the boxes in mm.\n\nFor rectangle, you need to enter the length and width of the shape.\nFor a square, you need to enter one of the sides of the shape.\nFor a circle, you need to enter the RADIUS of the circle, and not the diameter.\n\nIf the calculation is not working, you have entered characters that can't be calculated. Ensure that you only place numbers into the calculation, and no letters or special characters.", fg="Black", anchor='w', font="none 12", wraplength=400) .grid(row=2, column=0, sticky=W)#Sub Heading
...
Label (window, text="Click on one of the buttons to access a calculation", fg="Black", font="none 12") .grid(row=2, column=0, sticky=W)
...
Label (window, text="Aconix (c) 2022", fg="Grey", anchor='sw', font="none 8", wraplength=400) .grid(row=8, column=0, sticky=W)#Copyright
Label (window, text=f"v{version_number}", fg="Grey", anchor='se', font="none 8", wraplength=400) .grid(row=8, column=1, sticky=W)#version
